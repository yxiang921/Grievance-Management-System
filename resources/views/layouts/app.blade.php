...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex">
        <!-- Sidebar -->
        <div id="sidebar"
            class="z-20 w-5/6 md:w-64 bg-white h-screen shadow-md hidden md:block fixed -left-full md:static">
            <div class="p-4 relative">
                ...
                <div class="cursor-pointer w-8 h-8 absolute top-4 right-4" onclick="toggleMenu()">
            ...
            <nav class="mt-6">
                <a href="#" class="flex items-center py-2 px-4 text-gray-700 bg-green-100 rounded-lg mb-2">
                    <svg class="w-5 h-5 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M3 7V4a1 1 0 012-0V1h10v3a1 1 0 012 0v3h1.76A1.24 1.24 0 0120 8.24v10.52A1.24 1.24 0 0118.76 20H1.24A1.24 1.24 0 010 18.76V8.24A1.24 1.24 0 011.24 7H3zm3 0V4h8v3H6zm5 10h2v-2h-2v2zm-4-4h6v-2H7v2z" />
                    </svg>
                    Dashboard
                </a>
        ...
        <div class="flex-1">
            <div class="px-6 py-2 flex justify-between items-center">
                ...
                <div class="w-8 h-8 flex cursor-pointer" onclick="toggleMenu()">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                        stroke="currentColor" className="size-6">
