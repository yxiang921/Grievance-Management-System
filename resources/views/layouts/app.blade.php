        ...
        <div id="sidebar"
            ...
            <div class="p-4 relative">
                <div class="flex flex-col justify-center items-center">
                    <img src="https://pics.craiyon.com/2023-07-02/9a4508b794e8480ab55e484905e31b23.webp"
                        alt="Profile Pic" class="rounded-full w-20 h-20 mb-4">
            ...
            <nav class="mt-6 w-full flex flex-col items-center justify-center">
                ...
                <div
                    ...
                    <a href="{{ route('admin.grievances') }}"
                        ...
                        <span class="pl-4">Grievances</span>
                    </a>
                </div>
                ...
                <div
                    ...
                    <a href="{{ route('admin.departments') }}"
                        ...
                        <span class="pl-4">Departments</span>
                    </a>
                </div>
                ...
                w-full h-12 flex justify-center relative my-2">
                    <a href="{{ route('admin.analytics') }}"
                        ...
                        <span class="pl-4">Analytics</span>
                    </a>
                </div>
                ...
                <div class="nav-link
                    {{ Route::current()->getName() == 'admin.admins' ? 'active' : '' }}
                w-full h-12 flex justify-center relative my-2">
                    <a href="{{ route('admin.admins') }}" class="w-5/6 h-12 font-semibold flex items-center py-2 px-4 rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <span class="pl-4">Admins</span>
                    </a>
                </div>

                <div class="nav-link
                    {{ Route::current()->getName() == 'admin.settings' ? 'active' : '' }}
                w-full h-12 flex justify-center relative my-2">
                    <a href="{{ route('admin.settings') }}" class="w-5/6 h-12 font-semibold flex items-center py-2 px-4 rounded-lg">
