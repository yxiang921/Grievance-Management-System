    ...
    <div id="sidebar"
        ...
        <nav class="mt-6 w-full flex flex-col items-center justify-center">
            ...
            ">
                ...
                <span class="ml-3 text-sm font-medium"> Setting </span>
            </a>
    ...
    <div id="sidebar"
        ...
        <nav class="mt-6 w-full flex flex-col items-center justify-center">
            <a href="{{ route('department.home') }}"
                class="w-full h-10 mt-2 flex items-center rounded-lg px-4 py-2
            {{ Route::current()->getName() == 'department.home' ? 'active' : 'unactive' }}
            ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('department.grievances') }}"
                class="w-full h-10 mt-2 flex items-center rounded-lg px-4 py-2
            {{ in_array(Route::current()->getName(), ['department.grievances', 'department.grievance.detail'])
                ? 'active'
                : 'unactive' }}
            ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <a href="{{ route('department.analytics') }}"
                class="w-full h-10 mt-2 flex items-center rounded-lg px-4 py-2
            {{ Route::current()->getName() == 'department.analytics' ? 'active' : 'unactive' }}
            ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('department.map') }}"
                class="w-full h-10 mt-2 flex items-center rounded-lg px-4 py-2
            {{ Route::current()->getName() == 'department.map' ? 'active' : 'unactive' }}
            ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            ...
            <a href="{{ route('department.settings') }}"
                class="w-full h-10 mt-2 flex items-center rounded-lg px-4 py-2
            {{ Route::current()->getName() == 'department.settings' ? 'active' : 'unactive' }}
            ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
