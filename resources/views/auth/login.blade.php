    ...
    <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            ...
            <form class="max-w-md md:ml-auto w-full" method="POST" action="{{ route('login') }}">
                ...
                <div class="space-y-4">
                    <div>
                        {{-- <input :value="__('Email')" name="email" type="email" autocomplete="email" required
                    ...
                    <div>
                        {{-- <input :value="__('Password')" name="password" type="password" autocomplete="current-password"
                            required
                            class="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent"
